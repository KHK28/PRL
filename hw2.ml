...
= fun b1 b2 -> match b1 with
			| hd::tl -> (match b2 with
					| hd::tl -> reverse(reversed_multiply (reverse b1) (reverse b2) 0)
					| [] -> reverse(reversed_multiply (reverse b1) [ZERO] 0))
			| [] -> (match b2 with
					| hd::tl -> reverse(reversed_multiply [ZERO] (reverse b2) 0)
					| [] -> reverse(reversed_multiply [ZERO] [ZERO] 0))
